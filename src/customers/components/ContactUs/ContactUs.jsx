...
export default function ContactUs({ SecName }) {
  ...
  return (
    <div className='px-4 lg:px-8'>
      <h2 className='text-3xl text-black py-4 text-center'>{SecName}</h2>
      <div className='flex flex-row justify-center items-center space-x-10 py-2'>
        <img
          src='./Images/ContactUs/Contact_us_2.png'
          className='w-1/4 bg-stone-200 rounded-lg hover:bg-[#fffbf8] hover:border-2 hover:border-stone-800 transition duration-300 ease-in-out cursor-pointer'
          alt='Contact Us 2'
